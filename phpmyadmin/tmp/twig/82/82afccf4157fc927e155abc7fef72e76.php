...
class __TwigTemplate_44fe780ede193790a79b3a4ae6039bba extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "database/triggers/list.twig", "/srv/http/ez-srs/phpmyadmin/templates/database/triggers/list.twig");
    }
}
