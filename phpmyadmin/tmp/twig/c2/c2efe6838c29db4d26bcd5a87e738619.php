...
class __TwigTemplate_ddbb2dceb6389c299aef048fffac5bfe extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "columns_definitions/column_definitions_form.twig", "/srv/http/ez-srs/phpmyadmin/templates/columns_definitions/column_definitions_form.twig");
    }
}
