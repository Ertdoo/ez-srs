...
class __TwigTemplate_5ab5ec0998c67bb77de49d960aa06aac extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/srv/http/ez-srs/phpmyadmin/templates/database/export/index.twig");
    }
}
